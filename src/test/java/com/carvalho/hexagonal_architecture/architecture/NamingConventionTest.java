package com.carvalho.hexagonal_architecture.architecture;
...
@AnalyzeClasses(packages = "com.carvalho.hexagonal_architecture")
public class NamingConventionTest {
    ...
    public static final ArchRule mapper_reside_only_mapper_package = classes()
            ...
            .as("Mapper classes should inside mapper package in controller, client, consumer or repository package");
    ...
    public static final ArchRule config_reside_only_config_package = classes()
            ...
            .should()
            .resideInAPackage("..hexagonal_architecture.config")
